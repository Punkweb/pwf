...
function createListener(redraw?: any) {
...
function updateEventListeners(oldVnode: VNode, vnode?: VNode, redraw?: any): void {
  ...
  if (on) {
    ...
    const listener = ((vnode as any).listener = (oldVnode as any).listener || createListener(redraw));
